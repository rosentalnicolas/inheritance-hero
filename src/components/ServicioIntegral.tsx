const ServicioIntegral = () => {
  return (
    ...
    <section className="py-20 bg-slate-200 text-slate-900">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-6">
            <h2 className="font-serif text-[#C5A059] text-2xl md:text-3xl lg:text-4xl leading-tight uppercase tracking-tight font-bold">
              ABONA LA SUCESIÓN <span className="block text-slate-900">CON LA VENTA</span>
            </h2>
          ...
          <div className="space-y-6">
            <h2 className="font-serif text-[#C5A059] text-2xl md:text-3xl lg:text-4xl leading-tight uppercase tracking-tight font-bold">
              SERVICIO <span className="block text-slate-900">INTEGRAL</span>
            </h2>
            <div className="h-1 w-20 bg-[#C5A059]/40 mb-6"></div>
            <p className="text-slate-600 font-sans leading-relaxed text-sm md:text-base">
              Contamos con un amplio equipo de profesionales brindando valor agregado en las áreas 
              <strong className="text-slate-900 font-semibold"> jurídica, inmobiliaria y notarial</strong>.
            </p>
            <p className="text-slate-600 font-sans leading-relaxed text-sm md:text-base">
