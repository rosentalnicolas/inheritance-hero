      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          <div>
            ...
            <div className="flex items-start gap-2 text-slate-600 text-sm font-sans mb-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-slate-500 text-sm font-sans ml-2">100+ reseñas</span>
            </div>
            ...
            <div className="space-y-4">
              {googleReviews.map((r, i) => (
                <div key={i} className="bg-white rounded-xl p-5 border border-slate-200 shadow-sm">
                  ...
                  <p className="text-slate-600 font-sans text-sm leading-relaxed mb-3 italic">
                    «{r.text}»
                  </p>
                  <div className="flex justify-between items-center">
                    <span className="font-sans font-bold text-slate-800 text-sm">{r.name}</span>
                    <span className="text-slate-400 text-xs font-sans">{r.date}</span>
                  </div>
                </div>
              ))}
            </div>
